...
def test_status_event_metadata_records_tools_checkpoint_and_errors():
    ...
    assert metadata == {
        ...
        "checkpoint": {"saved": True, "message": "ok"},
...
def test_status_event_metadata_can_record_checkpoint_save_result_from_caller():
    metadata = build_status_event_metadata(
        {"process": "SAVE_CHECKPOINT"},
