...
def test_ensure_fork_checks_sophie_fork_repo_endpoint():
    """Verify ensure fork checks sophie fork repo endpoint."""
    sophie = make_sophie()
...
def test_ensure_fork_creates_sophie_fork_when_missing():
    """Verify ensure fork creates sophie fork when missing."""
    sophie = make_sophie()
...
def test_ensure_fork_skips_creation_when_sophie_fork_exists():
    """Verify ensure fork skips creation when sophie fork exists."""
    sophie = make_sophie()
